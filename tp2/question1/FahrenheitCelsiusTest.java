...
public class FahrenheitCelsiusTest extends junit.framework.TestCase {
    ...
    public void test_fahrenheitEnCelsius() {
        ...
        // Test ajoutes
        assertEquals("   10 °F -> -12.2 °C ?", -12.2, question1.FahrenheitCelsius.fahrenheitEnCelsius(10), 0.1);
        assertEquals("   20 °F -> -12.2 °C ?", -6.6, question1.FahrenheitCelsius.fahrenheitEnCelsius(20), 0.1);
    }
